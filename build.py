...
try:
    ...
    # Replace remote CDN KaTeX/Prism headers with locally bundled, fully inlined
    # versions for all targets (Chrome, Firefox, Chromium).
    # KaTeX fonts are embedded as base64 data: URIs so exported HTML is 100% standalone offline.
    ...
    if not os.path.exists(html_formatter_path):
        ...
        print(f"Inlining KaTeX + Prism bundles for {target} target...")
